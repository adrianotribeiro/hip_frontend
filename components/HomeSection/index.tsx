...
export default function HomeSection(): React.ReactElement {
  return (
    <section className="py-12 md:h-fit lg:justify-between xl:flex xl:h-[90vh] xl:items-center xl:py-[0.20rem] h-xl:h-[91.6vh] lg-xl:h-[91.1vh] sm-2xl:h-[89.6vh] 3xl:h-[92.4vh] 4xl:h-[92.6vh]">
      <div className="hidden xl:inline xl:overflow-hidden">
        <Image
          width={841}
          height={830}
          alt="Horse Image"
          className="r-img xl:w-[660px] 2xl:w-[1039px] h-xl:absolute h-xl:-left-40 h-xl:top-16 h-xl:w-[800px] lg-xl:w-[760px] sm-2xl:w-[620px] 3xl:absolute 3xl:left-[-8rem] 3xl:top-[4rem] 3xl:w-[890px] 4xl:left-[-4rem] 4xl:w-[917px]"
      ...
      <div className="xl:w-[50%] 2xl:w-[55%] 2xl:pr-3">
        ...
        <div className="flex flex-col items-center gap-5 px-8 xl:flex-row lg-xl:gap-4 lg-xl:px-[2.5rem] sm-2xl:py-0 3xl:px-11 3xl:py-4 4xl:px-12">
          <KnowMore link="#" />
          <KnowMore link="#" />
        </div>
      </div>
